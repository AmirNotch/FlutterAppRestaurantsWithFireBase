...
import 'package:flutter_app/screen/categories.dart';
import 'package:flutter_app/screen/detail_page.dart';
import 'package:flutter_app/screen/widget/bottom_Container.dart';
...
////2nd
  ...
  Widget build(BuildContext context) {
    ...
    var singleFoodList = provider.throwFoodModleList;
            ...
            child: Column(
              ...
              children: [
                UserAccountsDrawerHeader(
                  ...
                  accountName: Text("Delivery Almau"),
                  accountEmail: Text("ibragimov-amir@list.ru"),
                ),
